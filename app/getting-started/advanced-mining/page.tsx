    ...
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-col gap-5">
        ...
        <Card className="px-6 py-4">
          ...
          <CardContent>
            <p>Launch the Orion Client and go to the <strong>Benchmarks</strong> section. Run benchmarks to identify the best algorithm for your hardware.</p>
          </CardContent>
        </Card>
        ...
        <Card className="px-6 py-4">
          ...
          <CardContent>
            <p>Once the setup is complete, simply hit the <strong>Mine</strong> button. The Orion Client will handle connecting to the pool and optimizing your mining output.</p>
          </CardContent>
        </Card>
