      ...
      <div className="flex flex-col gap-5">
        ...
        <Card className="px-6 py-4">
          ...
          <CardContent>
            ...
            <p className="mt-2">Note: Your connected main wallet will receive the mining rewards, not the app&#39;s hot wallet.</p>
          </CardContent>
        </Card>
        ...
        <div className="text-center">
          ...
          <p className="text-lg">
            Start mining COAL efficiently on your mobile device. Remember to monitor your device&#39;s temperature and battery usage for optimal performance and longevity.
          </p>
        </div>
      </div>
    </div>
